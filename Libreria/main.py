import os
from Interfaces.InterfazLibros import InterfazLibros
from Interfaces.InterfazEmpleados import InterfazEmpleados
...
class MenuPrincipal:
    ...
    def mostrar_menu_principal(self):
        ...
        """
        print("\n" + "="*60)
        print("   SISTEMA DE GESTIÓN DE DATOS BIBLIORED")
        print("="*60)
