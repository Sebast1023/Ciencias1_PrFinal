...
class ArbolAVL:
    ...
    def insertar(self, nodo: Optional[NodoAVL], entidad: Base, mostrar_mensajes: bool = True) -> NodoAVL:
        """
    ...
    def actualizar_entidad(self, codigo: int, nueva_entidad: Base):
        """
    ...
    def buscar_por_codigo(self, codigo: int) -> Optional[Base]:
        """
    ...
    def mostrar_arbol_binarytree(self):
        print("\n[AVISO] La visualización del árbol fue deshabilitada.")
        """
