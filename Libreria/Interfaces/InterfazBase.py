...
from BD.GestorBD import GestorBD
import json

class InterfazBase(ABC):
    def __init__(self, archivo_json: str, clase_entidad: Type[Base], nombre_entidad: str):
        ...
        Args:
            ...
            clase_entidad (Type[Base]): La clase de la entidad
            nombre_entidad (str): El nombre de la entidad en singular
        """
        self.gestor = GestorBD(archivo_json, clase_entidad, nombre_entidad)
    ...
    def mostrar_menu(self):
        ...
        """
        print("\n" + "="*50)
        print(f"   GESTOR DE {self.nombre_entidad.upper()}S")
        print("="*50)
    ...
    @abstractmethod
    def solicitar_datos_entidad(self, codigo_actual: Optional[int] = None) -> Optional[Base]:
        """
        ...
        Returns:
            Optional[Base]: Una instancia de la entidad con los datos ingresados o None si hubo error
        """
        pass
        ...
        if opcion in campos and opcion != '1':
            ...
            try:
                with open(self.gestor.archivo_json, "r", encoding="utf-8") as archivo:
                    ...
                    es_numerico = campo.lower() in ["cedula", "codigo"]
